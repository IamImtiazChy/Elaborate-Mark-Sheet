    ...
    <table border="1">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if ($row["a1"] == 0 & $row["b1"] == 0 & $row["c1"] == 0 & $row["d1"] == 0) {
                    echo '<th colspan="4">' . $dot . "</th>";
                } else {
                    echo '<th colspan="4">' . $row["Question1"] . "</th>";
                }

                if ($row["a2"] == 0 & $row["b2"] == 0 & $row["c2"] == 0 & $row["d2"] == 0) {
                    echo '<th colspan="4">' . $dot . "</th>";
                } else {
                    echo '<th colspan="4">' . $row["Question2"] . "</th>";
                }

                if ($row["a3"] == 0 & $row["b3"] == 0 & $row["c3"] == 0 & $row["d3"] == 0) {
                    echo '<th colspan="4">' . $dot . "</th>";
                } else {
                    echo '<th colspan="4">' . $row["Question3"] . "</th>";
                }

                if ($row["a4"] == 0 & $row["b4"] == 0 & $row["c4"] == 0 & $row["d4"] == 0) {
                    echo '<th colspan="4">' . $dot . "</th>";
                } else {
                    echo '<th colspan="4">' . $row["Question4"] . "</th>";
                }

                if ($row["a5"] == 0 & $row["b5"] == 0 & $row["c5"] == 0 & $row["d5"] == 0) {
                    echo '<th colspan="4">' . $dot . "</th>";
                } else {
                    echo '<th colspan="4">' . $row["Question5"] . "</th>";
                }

                if ($row["a6"] == 0 & $row["b6"] == 0 & $row["c6"] == 0 & $row["d6"] == 0) {
                    echo '<th colspan="4">' . $dot . "</th>";
                } else {
                    echo '<th colspan="4">' . $row["Question6"] . "</th>";
                }

                if ($row["a7"] == 0 & $row["b7"] == 0 & $row["c7"] == 0 & $row["d7"] == 0) {
                    echo '<th colspan="4">' . $dot . "</th>";
                } else {
                    echo '<th colspan="4">' . $row["Question7"] . "</th>";
                }

                if ($row["a8"] == 0 & $row["b8"] == 0 & $row["c8"] == 0 & $row["d8"] == 0) {
                    echo '<th colspan="4">' . $dot . "</th>";
                } else {
                    echo '<th colspan="4">' . $row["Question8"] . "</th>";
                }

                if ($row["a9"] == 0 & $row["b9"] == 0 & $row["c9"] == 0 & $row["d9"] == 0) {
                    echo '<th colspan="4">' . $dot . "</th>";
                } else {
